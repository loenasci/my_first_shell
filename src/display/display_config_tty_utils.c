...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   display_config_tty_utils.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lsarraci <lsarraci@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/06 17:47:54 by lsarraci          #+#    #+#             */
/*   Updated: 2026/01/06 18:07:09 by lsarraci         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	verify_utf8_variants(const char *str)
{
...
static int	verify_undotted_utf8_variants(const char *str)
{
	char	*utf8_variants[5];
	size_t	i;
